...
NUM_CHAINS = "num chains placeholder"
# Sizes of the protein features, NUM_RES and NUM_MSA_SEQ are allowed as placeholders
...
FEATURES = {
    ...
    "aatype": (tf.int64, [NUM_RES, 21]),
    "between_segment_residues": (tf.int64, [NUM_RES, 1]),
    "deletion_matrix": (tf.float32, [NUM_MSA_SEQ, NUM_RES, 1]),
    "domain_name": (tf.string, [1]),
    "pdb_cluster_size": (tf.int64, [1]),
    "msa": (tf.int64, [NUM_MSA_SEQ, NUM_RES, 1]),
    ...
    "atom14_gt_positions": (
        tf.float32,
        [NUM_RES, residue_constants.atom14_type_num, 3],
    ),
    ...
    "atom14_atom_exists": (
        tf.float32,
        [NUM_RES, residue_constants.atom14_type_num],
    ),
    "atom14_gt_exists": (
        tf.float32,
        [NUM_RES, residue_constants.atom14_type_num],
    ...
    "residx_atom37_to_atom14": (
        tf.int64,
        [NUM_RES, residue_constants.atom_type_num],
    ),
    "atom37_atom_exists": (
        tf.float32,
        [NUM_RES, residue_constants.atom_type_num],
