...
def sharded_apply(
    ...
    def mapped_fn(*args):
        ...
        if remat:
            scan_iteration = hk.remat(scan_iteration)

        # If we are going to use the slice_starts range in hk.scan with
        # rematerialistion, we need to use np.arange and *not* jnp.arange.
        # Why? I don't really get it either, but check out
        # https://github.com/google/jax/issues/5186.
