...
from manyfold.model import all_atom, common_modules, prng, quat_affine, r3, utils
...
def supervised_chi_loss(ret, batch, value, config):
    ...
    # When preparing chi_angles with alphafold.model.all_atom.atom37_to_torsion_angles,
    # they are already returned with sin/cos as the last dimension
    # (batch["chi_angles"][...,2]).
    sin_cos_true_chi = batch["chi_angles"][None]
